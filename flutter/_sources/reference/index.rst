.. meta::
   :description: Full reference documentation for Flutter widgets, MaterialApp.router, GoRouter, Scaffold, Container, Center, and all routing parameters with examples.
   :keywords: Flutter Reference, MaterialApp.router, GoRouter, Widgets, Flutter Routing, Navigator 2.0, Flutter Documentation, Dart UI
...
.. toctree::
   ...
   0_widget.rst 
   1_materialapp.rst
   1_2_materialapp_router.rst
   1_3_gorouter.rst 
   1_4_goroute.rst 
   2_scaffold.rst 
   3_appbar.rst 
   4_center.rst 
   4_1_routerconfig.rst
   5_container.rst 
   6_column.rst 
   7_row.rst
   8_page.rst
   9_materialpage.rst
   10_customtransitionpage.rst 
   callbacks_handlers.rst 
