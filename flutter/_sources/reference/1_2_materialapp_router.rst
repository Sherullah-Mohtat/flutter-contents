.. meta::
   :description: Complete guide to Flutter MaterialApp.router including all named parameters, explanations, examples, deep linking, Navigator 2.0 navigation, and full working programs.
   :keywords: Flutter, MaterialApp.router with sherullah, Navigator 2.0, RouterConfig, GoRouter, Deep Linking, Routing, Navigation, Flutter Web, Flutter Navigation Tutorial, Route Management
...
+-----------------------------+-------------------------------------------------+
| “Push & pop pages manually” | “Router decides the page for you”               |
+-----------------------------+-------------------------------------------------+
| Navigator 1.0               | Navigator 2.0                                   |
+-----------------------------+-------------------------------------------------+

**✅ Basic Structure of MaterialApp.router()**
...
**✅ Step 2: main.dart (Simple program using routerConfig)**
    ...
    class MyApp extends StatelessWidget {
        ...
        Widget build(BuildContext context) {
            return MaterialApp.router(
                ...
                routerConfig: _router,   // 👈 THIS IS THE MAIN PART
            );
        }
    }
...
It tells Flutter:
    ...
    ✅ What their paths are (/ and /about)
...
Flutter looks at routerConfig and says:
    ...
    “Okay, /about = AboutPage” → then opens that screen.
    ...
    class MyRouterDelegate extends RouterDelegate<Object> with ChangeNotifier, PopNavigatorRouterDelegateMixin<Object> {
        ...
        Widget build(BuildContext context) {
            return Navigator(
                ...
                // ✅ New API – used instead of deprecated onPopPage
        ...
        Widget build(BuildContext context) {
            ...
            return Scaffold(
                ...
                body: Center(
                    child: ElevatedButton(
                        onPressed: () {
                            // 👇 Using routerDelegate to navigate
                            delegate.goToAbout();
                        },
                        child: const Text('Go to About Page'),
                    ),
...
That means:
    ...
    **“Don’t handle navigation yourself — let MyRouterDelegate control it.”**
...
So your routerDelegate says:
    ...
    If _showAboutPage is true → show About page

    If false → don’t show About page
...
So the flow is:
	1.	Button pressed → delegate.goToAbout()

	2.	_showAboutPage = true

	3.	notifyListeners() tells Flutter: **“Rebuild pages”**
...
If About page is removed → switch _showAboutPage back to false → show Home again

Again, that logic is in **routerDelegate.**

So routerDelegate is not just about going forward — it also controls **back navigation.**
...
Think of routerDelegate as a **security guard at a door:**
    ...
    You: “Send the user back”
    Delegate: ✅ removes page

    You: “Only allow About page if true”
    Delegate: ✅ uses condition (_showAboutPage)
...
**✅ Complete Working Example (main.dart)**
...
You are saying:
    ...
    “When the URL is /about, I want to show the About page.”
...
✅ That is exactly **how deep linking & web routing work**
...
When you provide your own — **you are the source of the route.**

Think of it like:

    **“Where does the app get the current path from?”**

**✅ Simple Working Example: routeInformationProvider**
                ...
                body: Center(
                    child: ElevatedButton(
                        onPressed: () {
                            ...
                            provider.updateRoute('/about'); // 👈 THIS LINE
...
**🔍 Focus on routeInformationProvider**
...
Think like this:
    ...
    Provider = “Here is the path”

    Parser = “I understand the path”

    Delegate = “I show the page”
...
**✅ Simple working example showing backButtonDispatcher**
    ...
    class MyApp extends StatelessWidget {
        ...
        Widget build(BuildContext context) {
            return MaterialApp.router(
                ...
                // ✅ THIS IS THE POINT OF THIS EXAMPLE
...
This says:
    ...
    “Let the Router system manage the back button in a smart way.”

When you press:
	•	Back on **About page** → it goes to **Home**

	•	Back on **Home** → app closes (or browser back works)
...
Whatever you put in builder will be applied to **every page** in your app — like a global layer.
...
Think like this:
    ...
    builder = “Wrap my entire app inside this widget”

**✅ Simple example: builder: in action**
...
**✅ Simple program to describe title: in MaterialApp.router**
...
**✅ Simple program to describe onGenerateTitle**
    ...
    class MyApp extends StatelessWidget {
        ...
        Widget build(BuildContext context) {
            return MaterialApp.router(
                ...
                // 👇 FOCUS: Dynamic title instead of fixed `title:`
...
Now the app title changes based on time ✅
...
Not both.
If both are present → onGenerateTitle wins.
...
**✅ Simple program to describe color: in MaterialApp.router**
...
+===========================================+========================================+
| Scaffold background                       | ❌ No                                  |
+-------------------------------------------+----------------------------------------+
| Container color                           | ❌ No                                  |
+-------------------------------------------+----------------------------------------+
| AppBar color                              | ❌ No                                  |
+-------------------------------------------+----------------------------------------+
| Behind the entire app (window/background) | ✅ YES                                 |
+-------------------------------------------+----------------------------------------+
...
**✅ Simple program to describe theme: in MaterialApp.router**
...
The **theme applied it automatically ✅**

That is the purpose of theme:.

**✅ Simple meaning (remember this)**
...
**✅ Simple program to describe darkTheme: in MaterialApp.router**
    ...
    class MyApp extends StatelessWidget {
        ...
        Widget build(BuildContext context) {
            return MaterialApp.router(
                ...
                // 👇 DARK THEME (MAIN FOCUS)
                darkTheme: ThemeData.dark(),

                // 👇 Uses device/system setting (Light or Dark)
...
So:
	...
	•	Reload app → UI becomes dark

	•	Switch back to Light Mode → UI becomes light

That’s all controlled from **MaterialApp.router.**

**✅ Important: Relationship of 3 things**
...
**✅ Simple program for highContrastTheme in MaterialApp.router**
...
This tells Flutter:
    ...
    “When the user turns on **High Contrast Mode** for accessibility, use THIS theme.”
...
This is for **people with visual difficulties 👓**

**✅ When is this theme used?**

When the **device accessibility setting** is:

✅ High Contrast ON
❌ Not normal light/dark switch
...
| darkTheme              | Dark Mode                     |
+------------------------+-------------------------------+
|✅ highContrastTheme    |Accessibility: High Contrast ON|
+------------------------+-------------------------------+
...
**✅ Simple program for highContrastDarkTheme**
...
**highContrastDarkTheme is used when the user turns ON:**
    ...
    ✅ High Contrast (in Accessibility)
...
This example lets you **switch between Light, Dark, and System mode** by pressing buttons — so you can visually understand exactly what themeMode does.

**✅ Simple program to describe themeMode: in MaterialApp.router**
...
This is EXACTLY what themeMode controls:
    **👉 Which theme Flutter should use right now**
...
**✅ Simple program to demonstrate themeAnimationDuration**
    ...
    class _MyAppState extends State<MyApp> {
        ...
        Widget build(BuildContext context) {
            return MaterialApp.router(
                ...
                // 👇 THIS is the parameter we're demonstrating
...
So when you press **“Toggle Theme”:**
	•	Without this → instant change 

	•	With this → smooth animated change in **2 seconds**
...
Think of it like:
    ...
    “How fast should my app fade from light ↔ dark?”
...
**✅ Simple program to demonstrate themeAnimationCurve**
    ...
    class _MyAppState extends State<MyApp> {
        ...
        Widget build(BuildContext context) {
            return MaterialApp.router(
                ...
                // 👇 MAIN FOCUS: CURVE OF THE ANIMATION
...
Now your theme change will **bounce 😄**

**✅ Super simple definition (remember this)**
...
**✅ Simple program to describe themeAnimationStyle**
    ...
    class _MyAppState extends State<MyApp> {
        ...
        Widget build(BuildContext context) {
            return MaterialApp.router(
                ...
                // 👇 MAIN FOCUS: themeAnimationStyle
...
•	AnimationStyle.duration → how long the **theme change animation** takes

•	AnimationStyle.curve → how the animation **moves over time**
...
**✅ Simple program to describe locale: in MaterialApp.router**
                            ...
                            child: Column(
                                ...
                                children: [
                                    ...
                                    ElevatedButton(
                                        ...
                                        child: const Text('پښتو ته واړوئ'),
                                    ),
                                ],
                            ),
                        ),
...
**What you’ll see**
	...
	•	Start: **English** – “Hello (English)”

	•	Tap **“پښتو ته واړوئ”** → locale becomes ps
...
**✅ Simple program to describe supportedLocales in MaterialApp.router**
...
“My app is able to support **only these languages.**”

If the user’s phone is set to:

	•	French → ❌ Not in list → Flutter won’t use it

	•	Pashto → ✅ In list → Flutter will use Pashto

	•	Spanish → ✅ In list → Flutter will use Spanish

Think of it like a whitelist of languages your app allows.

**✅ Very short definition (remember this)**
...
This example proves one thing:
    ...
    **localizationsDelegates is what provides localized strings (like “Back”, dates, numbers, text direction, etc.) for the selected locale.**
...
**✅ Simple program to describe localizationsDelegates in MaterialApp.router**
...
This tells Flutter:
    ...
    “Here are the objects that provide translations and regional settings
...
With this:
    ...
    ✅ Proper RTL for Pashto

    ✅ Normal English / Spanish

    ✅ No red error

**✅ Super simple meaning (remember forever)**
...
Without it → your app WILL crash when you change locale.
...
**✅ Simple program: localeResolutionCallback in MaterialApp.router**
...
localeResolutionCallback means:
    ...
    “Flutter, when the app starts, check the phone’s language. Then I will decide which language my app should use.”
...
**✅ What this example does**
	...
	•	The app:
        ...
        •	✔️ Uses **Pashto** if found

        •	✔️ Else uses **Spanish** if found

        •	✔️ Else uses **English by default**

	•	It prints the decision in the console

**✅ Simple program: localeListResolutionCallback in MaterialApp.router**
...
localeListResolutionCallback =
    ...
    “Flutter, here is a list of languages my user prefers. You choose the best one.”
...
✅ The red **DEBUG** banner will **disappear.**
...
debugShowCheckedModeBanner means:
    ...
    “Flutter, should I show the red DEBUG label or not?”
...
**✅ Simple Program: debugShowMaterialGrid in MaterialApp.router**
...
✅ Checking widget alignment

✅ Checking padding / margins
...
| Value                     | Result                        |
+===========================+===============================+
| true                      | Shows layout grid on screen ✅|
+---------------------------+-------------------------------+
| false                     | No grid (normal UI) ✅        |
+---------------------------+-------------------------------+

debugShowMaterialGrid =

    “Flutter, show me your layout lines so I can design better.”
...
**✅ Simple program: showPerformanceOverlay in MaterialApp.router**
...
If bars go **above the line** → ⚠️ your app is becoming slow.

**✅ In very simple words**

showPerformanceOverlay =

    “Flutter, show me how fast or slow my app is running.”

+-----------------+---------------------------------+
| Value           | Result                          |
+=================+=================================+
| true            | Shows performance graph ✅      |
+-----------------+---------------------------------+
| false           | Normal mode ✅                  |
+-----------------+---------------------------------+
...
the **showSemanticsDebugger** parameter in **MaterialApp.router** — using the **new API (onDidRemovePage)** instead of the deprecated onPopPage.

showSemanticsDebugger is mainly used for **accessibility debugging** (screen readers, talkback, etc.).

**✅ Simple program: showSemanticsDebugger in MaterialApp.router**
...
showSemanticsDebugger = true means:
    ...
    “Flutter, show me how screen readers see my app.”

+------------------------+--------------------------------------------+
| Value                  | Result                                     |
+========================+============================================+
| true                   | Shows accessibility info on UI ✅          |
+------------------------+--------------------------------------------+
| false                  | Normal screen ✅                           |
+------------------------+--------------------------------------------+
...
**✅ Simple program: shortcuts in MaterialApp.router**
...
“Flutter, when the user presses these keys, do this action.”
...
**✅ Simple program: actions in MaterialApp.router**
...
.. code-block:: dart 
    ...
    Widget build(BuildContext context) {
            return MaterialApp.router(
                ...
                // 👇 THIS IS WHAT YOU ASKED ABOUT: actions
                actions: <Type, Action<Intent>>{
...
+--------------------+---------------------------------+
| actions:           | Connects intent ➜ action        |
+--------------------+---------------------------------+

actions = “When this thing happens, do this job”
...
In this example:
    ...
    ✅ A counter value is **saved automatically**

    ✅ Close the app

    ✅ Open it again → the counter is **restored**

**✅ Simple program: restorationScopeId in MaterialApp.router**
...
Flutter: “Remember everything under this name.”
...
**✅ Simple program: scrollBehavior in MaterialApp.router**
...
| Mouse wheel         | ✅                                            |
+---------------------+-----------------------------------------------+
| Mouse drag          | ✅ (because of custom scrollBehavior)         |
+---------------------+-----------------------------------------------+
| Trackpad            | ✅                                            |
+---------------------+-----------------------------------------------+
...
scrollBehavior =
    ...
    “Flutter, I want to customize how scrolling works in my app.”

+-----------------------------+---------------------------------------+
| Example change              | Result                                |
+=============================+=======================================+
| Add PointerDeviceKind.mouse | Drag with mouse ✅                    |
+-----------------------------+---------------------------------------+
| Remove it                   | Only wheel works ❌                   |
+-----------------------------+---------------------------------------+
| Add stylus                  | Stylus dragging ✅                    |
+-----------------------------+---------------------------------------+
...
In this example:
    ...
    ✅ When navigation happens, a message is printed in the console

    ✅ And a small text on screen changes

**✅ Simple program: onNavigationNotification in MaterialApp.router**
